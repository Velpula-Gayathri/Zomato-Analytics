...
ALTER TABLE Sheet1 RENAME COLUMN CountryCode TO Country_Code;
ALTER TABLE Sheet2 RENAME COLUMN Country_Code TO Countryid;
...
select  country_name,restaurantname,votes,Average_Cost_for_two from sheet1 inner join sheet2 on 
sheet1.country_code=sheet2.countryid
